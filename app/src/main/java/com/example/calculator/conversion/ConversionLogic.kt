...
class ConversionLogic {
    ...
    */
    val areaTable = listOf(listOf(1, 40.4686, 0.404686, 4.047e+7, 43560, 6.273e+6, 4046.86),
                            listOf(0.0247105, 1, 0.01, 1e+6, 1076.39, 155000, 100),
                            listOf(2.47105, 100, 1, 1e+8, 107639, 1.55e+7, 10000),
                            listOf(2.4711e-8, 1e-6, 1e-8, 1, 0.00107639, 0.155, 1e-4),
                            listOf(2.2957e-5, 0.00092903, 9.2903e-6, 929.03, 1, 144, 0.092903),
                            listOf(1.5942e-7, 6.4516e-6, 6.4516e-8, 6.4516, 0.00694444, 1, 0.00064516),
                            listOf(0.000247105, 0.01, 1e-4, 10000, 10.7639, 1550, 1))
    ...
    */
    val lengthTable = listOf(listOf(1, 0.1, 0.001, 1e-6, 0.0393701, 0.00328084, 0.00109361, 6.2137e-7, 5.3996e-7, 39.3701),
                              listOf(10, 1, 0.01, 1e-5, 0.393701, 0.0328084, 0.0109361, 6.2137e-6, 5.3996e-6, 393.701),
                              listOf(1000, 100, 1, 0.001, 39.3701, 3.28084, 1.09361 ,0.000621371, 0.000539957, 39370.1),
                              listOf(1e+6, 100000, 1000, 1, 39370.1, 3280.84, 1093.61, 0.621371, 0.539957, 3.937e+7),
                              listOf(25.4, 2.54, 0.0254, 2.54e-5, 1, 0.0833333, 0.0277778, 1.5783e-5, 1.3715e-5, 1000),
                              listOf(304.8, 30.48, 0.3048, 0.0003048, 12, 1, 0.333333, 0.000189394, 0.000164579, 12000),
                              listOf(914.4, 91.44, 0.9144, 0.0009144, 36, 3, 1, 0.000568182, 0.000493737, 36000),
                              listOf(1.609e+6, 160934, 1609.34, 1.60934, 63360, 5280, 1760, 1, 0.868976, 6.336e+7),
                              listOf(1.852e+6, 185200, 1852, 1.852, 72913.4, 6076.12, 2025.37, 1.15078, 1, 7.291e+7),
                              listOf(0.0254, 0.00254, 2.54e-5, 2.54e-8, 0.001, 8.3333e-5, 2.7778e-5, 1.5783e-8, 1.3715e-8, 1))
   ...
   */
    ...
    */
    val volumeTable = listOf(listOf(1, 1.20095, 4.54609, 4546.09, 4546.09, 0.00454609, 277.419, 0.160544),
                              listOf(0.832674, 1, 3.78541, 3785.41, 3785.41, 0.00378541, 231, 0.133681),
                              listOf(0.219969, 0.264172, 1, 1000, 1000, 0.001, 61.0237, 0.0353147),
                              listOf(0.000219969, 0.000264172, 0.001, 1, 1, 1e-6, 0.0610237, 0.168936),
                              listOf(0.000219969, 0.000264172, 0.001, 1, 1, 1e-6, 0.0610237, 0.168936),
                              listOf(219.969, 264.172, 1000, 1e+6, 1e+6, 1, 61023.7, 35.3147),
                              listOf(0.00360465, 0.004329, 0.0163871, 16.3871, 16.3871, 1.6387e-5, 1, 0.000578704),
                              listOf(6.22884, 7.48052, 28.3168, 28316.8, 28316.8, 0.0283168,  1728, 1))
    ...
    */
    val massTable = listOf(listOf(1, 0.984207, 1.10231, 2204.62, 35274, 1000, 1e+6),
                            listOf(1.01605, 1, 1.12, 2240, 35840, 1016.05, 1.016e+6),
                            listOf(0.907185, 0.892857, 1, 2000, 32000, 907.185, 907185),
                            listOf(0.000453592, 0.000446429, 0.0005, 1, 16, 0.453592, 453.592),
                            listOf(2.835e-5, 2.7902e-5, 3.125e-5, 0.0625, 1, 0.0283495, 28.3495),
                            listOf(0.001, 0.000984207, 0.00110231, 2.20462, 35.274, 1, 1000),
                            listOf(1e-6, 9.8421e-7, 1.1023e-6, 0.00220462, 0.035274, 0.001, 1))
    ...
    */
    val dataTable = listOf(listOf(1, 0.125, 0.000125, 1.25e-7, 1.25e-10, 1.25e-13),
                            listOf(8, 1, 0.001, 1e-6, 1e-9, 1e-12),
                            listOf(8000, 1000, 1, 0.001, 1e-6, 1e-9),
                            listOf(8e+6, 1e+6, 1000, 1, 0.001, 1e-6),
                            listOf(8e+9, 1e+9, 1e+6, 1000, 1, 0.001),
                            listOf(8e+12, 1e+12, 1e+9, 1e+6, 1000, 1))
    ...
    */
    ...
    val speedTable = listOf(listOf(1, 3600, 0.001, 3.6, 39.23, 141732.283, 3.28, 11811.023, 0.000621, 2.2369, 1.9438),
                             listOf(0.0002778, 1, 2.7778e-7, 0.001, 0.01093, 39.37007, 0.000911, 3.2808, 0.000000172, 0.000613, 0.0005399),
                             listOf(1000, 3600000, 1, 3600, 39370.07874, 141732283.46, 3280.839, 11811023.622, 0.6213, 2236.936, 1943.844),
                             listOf(0.2778, 1000, 0.0002778, 1, 10.936, 39370.078, 0.9113, 3280.8398, 0.000172, 0.62137, 0.5399),
                             listOf(0.0254, 91.44, 0.0000254, 0.09144, 1, 3600, 0.08333, 300, 0.00000157, 0.05681, 0.04937),
                             listOf(0.00000705, 0.0254, 0.0000000071, 0.0000254, 0.0002778, 1, 0.0000231, 0.08333, 0.0000000044, 0.00001578, 0.0000137),
                             listOf(0.3048, 1097.28, 0.0003048, 1.09728, 12, 43200, 1, 3600, 0.000189, 0.681, 0.592483),
                             listOf(0.00008467, 0.3048, 0.0000000847, 0.0003048, 0.00333, 12, 0.000277778, 1, 0.0000000526, 0.000189, 0.0001645),
                             listOf(1609.344, 5793638.4, 1.609, 5793.63, 63360, 228096000, 5280, 1900800, 1, 3600, 3128.3144),
                             listOf(0.44704, 1609.344, 0.00044, 1.609344, 17.6, 63360, 1.4667, 5280, 0.0002778, 1, 0.86897),
                             listOf(0.51444, 1852, 0.0005144, 1.852, 20.2537, 72913.385, 1.6878, 6076.1154, 0.000319, 1.1507, 1))
    ...
    */
    private val timeTable = listOf(listOf(1, 0.001, 1.6667e-5, 2.7778e-7, 1.1574e-8, 1.6534e-9),
                            listOf(1000, 1, 0.0166667, 0.000277778, 1.1574e-5, 1.6534e-6),
                            listOf(60000, 60, 1, 0.0166667, 0.000694444, 9.9206e-5),
                            listOf(3.6e+6, 3600, 60, 1, 0.0416667, 0.00595238),
                            listOf(8.64e+7, 86400, 1440, 24, 1, 0.142857),
                            listOf(6.048e+8, 604800, 10080, 168, 7, 1))
    ...
    */
    ...
    fun conversion(choice : Int, currentTop : Int, currentBottom : Int, value : String, divMul : Boolean) : String{
        var currentTable = listOf<List<Any>>()
        var outputString: String
