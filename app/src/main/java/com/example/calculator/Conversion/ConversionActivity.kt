...
class ConversionActivity: AppCompatActivity() {
    ...
    */
    private val areaTypes = listOf(
        SpinnerItem(GONE, "Acre (ac)", "#FFFFFF"),
    ...
    private val temperatureTypes = listOf(
        SpinnerItem(
            GONE,
            "Celsius (°C)",
            "#FFFFFF"
    ...
    private val volumeTypes = listOf(
        SpinnerItem(
            GONE,
            "UK Gallon (gal)",
            "#FFFFFF"
    ...
    private val massTypes = listOf(
        SpinnerItem(GONE, "Ton (t)", "#FFFFFF"),
        SpinnerItem(
            GONE,
            "UK Ton (t)",
            "#FFFFFF"
    ...
    private val dataTypes = listOf(
        SpinnerItem(GONE, "Bit (bit)", "#FFFFFF"),
    ...
    */
    private var conversionLogicUnit =
        ConversionLogic() //Initializes the Logic Class
